...
<form class="container-fluid" id="content_container" action="<?= base_url('polosan/save') ?>" method="post" enctype="multipart/form-data">
	<div class="card mb-5">
		...
		<div class="card-body row" id="div-info">
			...
			<div class="col-md-4">
				...
				<div class="input-group input-group-sm flex-nowrap mb-2">
					<input class="form-control" required id="tgl_pengiriman_input"
						name="tgl_pengiriman" value="<?= $x ? $x['tgl_pengiriman'] : '' ?>"/>
				</div>
			</div>
