			...
			<div class="modal-body scroll-y mx-5 mx-xl-15">
				<form id="form">
					<div class="fv-row mb-7">
						<label class="required fw-bold fs-6 mb-2">Nama Role</label>
						<input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0 name" required placeholder="Nama Role" />
					</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body scroll-y mx-5 mx-xl-15">
				<form id="form_edit">
					...
					<div class="fv-row mb-7">
						<label class="required fw-bold fs-6 mb-2">Nama Role</label>
						<input type="text" name="name" id="name-edit" class="form-control form-control-solid mb-3 mb-lg-0" required placeholder="Nama Role" />
					</div>
					<div class="text-center pt-15">
