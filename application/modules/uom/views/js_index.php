<script type="text/javascript">
	...
	function del(el,id) {
		Swal.fire({
			title: 'Perhatian !',
			text: 'Apakah anda ingin menghapus UoM ini ?',
			icon: 'warning',
		...
		table = $('#table').DataTable({
			...
			columns: [{
				...
				render: function (data, type, row) {
					...
					<button onclick="edit(this, ${data})" class="btn btn-icon btn-light btn-active-light-success"><i class="fa fa-pen"></i></button>
					<button class="btn btn-icon btn-light btn-active-light-danger" onclick="del(this,${data})"><i class="fa fa-trash"></i></button>
					</div>`
				},
			}],
			language: {
