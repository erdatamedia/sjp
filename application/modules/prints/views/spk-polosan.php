		...
		<div class="mw-lg-950px mx-auto w-100">
			...
			<div class="pb-12">
				<div class="d-flex flex-column gap-20 gap-md-10">
					...
					<div class="d-flex justify-content-between flex-column  gap-20 gap-md-10">
						<table class="table" style="border: 1px solid black;">
							<thead>
								<tr class="fs-6 fw-bolder" style="border: 1px solid black;">
									<th class=" text-center p-3" colspan="2">Order Detail</th>
								...
								<?php foreach ($x['detail_pekerjaan'] as $key => $item): ?>
									<?php if ($item['barang']): ?>
										...
										<td class="text-strat" style="color: blue;"><?= $item['barang']['item_box'] ?></td>
													...
													<tr class="fw-bolder" style="border: 1px solid black;">
														<th class="text-black" style="padding-left: 5px;">Product Size</th>
														<td class="text-start"><?= $item['barang']['size'] ?></td>
													</tr>
													<tr class="fw-bolder" style="border: 1px solid black;">
													...
													<tr class="fw-bolder" style="border: 1px solid black;">
														...
														<td >
															<pre class="text-start"><?= $item['deskripsi'] ? $item['deskripsi'] : '' ?></pre>
														</td>
