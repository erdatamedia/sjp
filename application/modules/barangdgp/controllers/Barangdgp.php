...
class Barangdgp extends MY_Controller
{
	public $module = 'barangdgp';
	public $id_column 	= 'id';
	...
	function index() {
		$module = $this->module;
		$data['module'] = $module;
		$data['title'] 	= 'Product Digital Printing';
		$data['sub_title'] = "Product Digital Printing";
		$data['sub']	= null;
		$page = $module.'/v_index';
		$js = $module.'/js_index';
	...
	function repeat() {
		$module = $this->module;
		$data['module'] = $module;
		$data['title'] 	= 'Product Repeat Digital Printing';
